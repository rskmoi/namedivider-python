...
GBDT_MODEL_V1_URL = (
    ...
    "/releases/download/Models/gbdt_model_v1.txt"
)
FAMILY_NAME_REPOSITORY_URL = (
    "https://github.com/rskmoi/namedivider-python"
    "/releases/download/Models/family_name_repository.pickle"
)
...
def download_family_name_pickle_if_needed(path: str | Path) -> None:
    """
...
def download_gbdt_model_v1_if_needed(path: str | Path) -> None:
    """
    When a default path is provided, download from the Internet if not already downloaded.
    """
